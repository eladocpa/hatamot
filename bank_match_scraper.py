...
class BankMatchScraper:
    ...
    def start_and_login(self):
        """
        פותח דפדפן, נכנס למסך הכניסה, ועוצר כדי שתזין
        שם משתמש וסיסמה ידנית. אחרי שתתחבר - תלחץ Enter בטרמינל.
        """
        ...
        print("\n" + "=" * 60)
        print("  ✋ עצור! עכשיו תורך:")
        print("  1. הקלד בדפדפן שם משתמש וסיסמה והתחבר ל-Maven.")
        print("  2. ודא שאתה רואה את המסך הראשי של המערכת.")
        print("  3. חזור לכאן ולחץ Enter כדי להמשיך.")
        print("=" * 60)
    ...
    # --------------------------------------------------------------
    def go_to_bank_match(self):
        """מנווט למסך התאמות הבנק של החברה."""
        print("\n🧭 עובר למסך התאמות הבנק...")
        self._page.goto(config.BANK_MATCH_URL)
